        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              {/* Right content - iframe placeholder */}
              <div className="md:w-1/2 bg-honey-50 p-6 md:p-8 flex items-center justify-center">
                <div className="w-full h-[600px] bg-white border border-gray-200 rounded-lg shadow-inner flex items-center justify-center">
                  <div className="text-center p-6">
                    <h3 className="text-2xl font-semibold text-beeBlack mb-4">Partner Onboarding Form</h3>
